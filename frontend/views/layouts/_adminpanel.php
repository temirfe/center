...
else if ($controller == 'project') $proj_active = "active";
?>
    ...
    <div class="admpanel-content js_admpanel-content">
        <div class="top_admpanel_wrapper">
            <div class="operations">
                ...
                <div class="<?= $comment_active ?>"><span class='panel-icon fa fa-folder'></span><?= Html::a(Yii::t('app', 'Projects'), ['/project/index']); ?></div>
            </div>
            <div class="clear"></div>
            <?php
            ...
            ?>
                <div class="operations" style="padding: 4px 13px; background-color: #000;">
                    ...
                    if ($controller == 'package') {
                        echo Html::a(
                            '<span class="fa fa-tag panel-icon2"></span> ' . Yii::t('app', 'Add item'),
                            ['/item/create', 'parent_id' => $id],
                            ['class' => 'mr30']
                        );
                    }
                    ?>
